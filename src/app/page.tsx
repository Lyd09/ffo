...
import { Menu, Camera, ArrowRight, Monitor, Code, Clapperboard, Film, Instagram, Briefcase } from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            ...
            <div className="flex justify-center items-center gap-4 mt-8">
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle>Atendimento via WhatsApp</AlertDialogTitle>
                    <AlertDialogDescription>
                      Para um atendimento mais rápido e eficiente, nosso contato é feito exclusivamente pelo WhatsApp. O Instagram é nosso portfólio. Deseja continuar para o Instagram mesmo assim?
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                    <AlertDialogCancel>Cancelar</AlertDialogCancel>
                    <AlertDialogAction onClick={() => window.open('https://www.instagram.com/_fastfilms_/?__pwa=1', '_blank')}>
            ...
            <div className="flex items-start gap-12 text-center md:text-left">
              <div className="flex flex-col items-center">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a href="https://www.instagram.com/_fastfilms_/?__pwa=1" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-primary transition-colors">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <span className="text-muted-foreground/50 cursor-not-allowed" aria-label="YouTube (em breve)">
